...
- Implemented clusters in visualization\\
- Node size changes based on number of correlations\\
- r threshold can be modified - input a list of thresholds + a slider to look through each one\\
...
TODO: Continue this cuz i lowkey can't think rn
